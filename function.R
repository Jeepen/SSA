library(survival)
simfunction <- function(n = 1e5, nsim = 100, l1 = 1, l2 = 1, t1 = 0, t2 = Inf, HR = 1, frailtyVar = 0, nsubs = Inf, 
                        seed = 25032022, adjust = "good", comprisk = FALSE){
    set.seed(seed)
